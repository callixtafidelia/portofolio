    ...
    <div className="h-screen bg-gray-50 flex overflow-auto">
      ...
      <main className="flex-1 min-h-screen p-8">
        <div className="max-w-6xl mx-auto">
          {/* Back to Home (uses Next/Link now) */}
          <Link
            href="/"
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                <div className="flex items-center mb-6 space-x-3">
                  <GraduationCap
                    size={20}
                    className="text-blue-600 w-10 h-10 bg-blue-100 p-2 rounded-lg"
                  />
                ...
                <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full inline-block">
                  GPA 3.8/4.0
                </span>
              ...
              <div className="bg-white rounded-xl shadow-sm border p-6">
                <div className="flex items-center mb-6 space-x-3">
                  <Award
                    size={20}
                    className="text-purple-600 w-10 h-10 bg-purple-100 p-2 rounded-lg"
                  />
                  <h3 className="text-xl font-bold text-gray-900">
                    Certifications
                  </h3>
